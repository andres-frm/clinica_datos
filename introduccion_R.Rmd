...
# Explore las funcionesnames(), colnames(), 
...
```
Su uso dependerá de la función y el propósito código que estén desarrollando.
...
plot(iris$Species, iris$Sepal.Length, 
     ylab = "Longitud sépalo", xlab = "Especie")
...
plot(iris$Petal.Width, iris$Sepal.Length, 
     col = ifelse(iris$Species == "setosa", "green",
                    ifelse(iris$Species == "virginica", "black", "blue")), pch = 19)
```
